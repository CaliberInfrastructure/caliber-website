      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
          ...
          <div className="bg-slate-950 p-10 rounded-[3rem] shadow-2xl flex flex-col justify-between relative overflow-hidden group">
            ...
            <a href="#demo" className="relative z-10 w-full py-4 bg-cyan-600 text-white text-center rounded-2xl text-xs font-black uppercase tracking-widest hover:bg-cyan-500 transition group-hover:scale-[1.02]">
              Book a Free Demo →
            </a>
