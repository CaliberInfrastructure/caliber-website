            ...
            <div className="bg-cyan-600 rounded-[3rem] p-10 text-white shadow-2xl relative overflow-hidden">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                <div>
                  ...
                  <div className="bg-cyan-700/50 px-4 py-2 rounded-xl border border-white/10 text-[9px] font-bold uppercase tracking-widest inline-flex items-center gap-2">
                    <span className="w-2 h-2 bg-green-400 rounded-full animate-pulse"></span> Deploy Full Autonomy System™
                  </div>
                </div>
            ...
            {showMethodology && (
              <div className="mt-4 bg-white border border-slate-100 rounded-[2.5rem] p-10 space-y-12 animate-in slide-in-from-top-4 duration-500 shadow-sm">
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-slate-50 p-6 rounded-2xl border border-slate-100 font-mono text-sm text-slate-600">
                    (Monthly Recovery - $2,000 Full Autonomy Fee) ÷ $2,000
                  </div>
                  <p className="text-slate-500 text-sm leading-relaxed max-w-3xl">
                    ROI is calculated against the <span className="font-bold text-slate-900">Full Autonomy System™ ($2,000/mo)</span>, our flagship infrastructure. Lower tiers will have different ROI profiles based on their monthly fee.
                  </p>
                </div>
                ...
                <div className="bg-slate-950 p-8 rounded-[2rem] text-center">
                  <p className="text-slate-400 text-sm italic">
                    These are estimates based on industry benchmarks. Your <span className="text-cyan-400 font-bold underline cursor-pointer">free demo</span> will walk through actual measurements specific to your practice.
                  </p>
                </div>
